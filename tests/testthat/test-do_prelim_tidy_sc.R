test_that("Testing do_prelim_tidy_sc() !", {
  data_demographics <- system.file("extdata",
                                   "data_demographics_sc.csv",
                                   package = "deidentifiedDB")
  output_tbl <- do_prelim_tidy_sc(read_demographics_csv(data_demographics))
  ...
  expect_equal(example_dp$test_group,
               stringr::str_to_upper('Testing-Sept2020'))
  expect_equal(example_dp$city,
  ...
  expect_equal(example_dp$ethnicity,
               stringr::str_to_upper('Not Hispanic or Latino'))
  expect_equal(example_dp$race, 'WHITE')
  expect_equal(example_dp$patient_id,
               '28b0b36a0c3594a81200c34d')
  expect_equal(example_dp$rymedi_result,
               stringr::str_to_upper('Negative'))
  expect_equal(as.character(example_dp$collection_date),
               "2021-09-30 08:19:48")
  expect_equal(example_dp$result_date,
  ...
  expect_equal(example_dp$performing_facility,
               stringr::str_to_upper('Clemson University Personnel'))
  expect_equal(example_dp$testing_facility,
